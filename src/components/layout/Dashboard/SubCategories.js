...
const demoSubCategories = [
  { sn: 868, id: 915, name: "Sanghi Sathi", category: "Salads", products: 0, status: "Active" },
  { sn: 867, id: 914, name: "Sanghi Sathi", category: "Salads", products: 0, status: "Active" },
  { sn: 866, id: 913, name: "Pasand Aap Ki Dal", category: "Main Course", products: 0, status: "Active" },
  { sn: 865, id: 912, name: "Subz Bahar", category: "Main Course", products: 0, status: "Active" },
  { sn: 864, id: 911, name: "Subz Bahar", category: "Main Course", products: 0, status: "Active" },
  { sn: 863, id: 910, name: "Chinese Meals", category: "Combos", products: 0, status: "Active" },
  { sn: 862, id: 909, name: "Kuch Khaas", category: "Main Course", products: 0, status: "Active" },
  { sn: 861, id: 908, name: "Rice & Noodles", category: "Chinese", products: 0, status: "Active" },
  { sn: 860, id: 907, name: "Chaap Special", category: "Main Course", products: 0, status: "Active" },
  { sn: 859, id: 906, name: "South Indian Dishes", category: "South Indian", products: 0, status: "Active" },
  { sn: 858, id: 905, name: "Biryani", category: "Biryani", products: 0, status: "Active" },
  { sn: 857, id: 904, name: "Dine & Biryani", category: "Biryani", products: 0, status: "Active" },
];
          ...
          <tbody>
            {paginatedData.map((item) => (
              <tr key={item.id} style={{ background: selected.has(item.id) && isDark ? "rgba(59,130,246,0.07)" : selected.has(item.id) ? "rgba(59,130,246,0.03)" : "transparent" }}>
                ...
                <td style={styles.td}><ImagePlaceholder name={item.name} isDark={isDark} /></td>
